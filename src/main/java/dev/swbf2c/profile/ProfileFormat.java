...
public final class ProfileFormat {
    ...
    public static final int PROFILE_NAME_OFFSET = 0x0006;
    public static final int PROFILE_NAME_SIZE_BYTES = 46;
    public static final int PROFILE_NAME_MAX_CHARS = 22;

    public static final int MEDALS_OFFSET = 0x057C;
    public static final int MEDAL_COUNT = 9;
    public static final int MEDAL_SIZE_BYTES = 2;

    public static final int STATS_OFFSET = 0x0F8C;
